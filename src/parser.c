...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_ident_pattern_token_character_set_1, 685, lookahead)) ADVANCE(154);
      END_STATE();
    case 1:
      ADVANCE_MAP(
        '!', 17,
    ...
    case 76:
      ...
      END_STATE();
    case 77:
      if (set_contains(sym_ident_pattern_token_character_set_2, 800, lookahead)) ADVANCE(154);
      END_STATE();
    case 78:
      if (eof) ADVANCE(79);
      ADVANCE_MAP(
