// Copyright (C) [2023] World Wide Web Consortium,
        ...
        builtin_function_name: $ => choice(
            $.numeric_builtin_function_name,
            $.derivative_builtin_function_name,
            $.texture_builtin_function_name,
            $.atomic_builtin_function_name,
            $.data_packing_builtin_function_name,
            $.data_unpacking_builtin_function_name,
            $.synchronization_builtin_function_name,
        ),
        numeric_builtin_function_name: $ => choice(
            token("abs"),
            token("acos"),
            token("abs"),
            token("acos"),
            ...
            token("cos"),
            token("cosh"),
            token("countLeadingZeros"),
            token("countOneBits"),
            token("countTrailingZeros"),
            token("cross"),
            token("degrees"),
            token("determinant"),
            token("distance"),
            ...
            token("extractBits"),
            token("faceForward"),
            token("firstLeadingBit"),
            token("firstTrailingBit"),
            token("floor"),
            token("fma"),
            token("fract"),
            token("frexp"),
        ...
        derivative_builtin_function_name: $ => choice(
            token("dpdx"),
            token("dpdxCoarse"),
            token("dpdxFine"),
            token("dpdy"),
        ...
        texture_builtin_function_name: $ => choice(
            token("textureDimensions"),
            token("textureGather"),
            token("textureGatherCompare"),
            token("textureLoad"),
            token("textureNumLayers"),
            token("textureNumLevels"),
            token("textureNumSamples"),
            token("textureSample"),
            token("textureSampleBias"),
            token("textureSampleCompare"),
            token("textureSampleCompareLevel"),
            token("textureSampleGrad"),
            token("textureSampleGrad"),
            token("textureSampleLevel"),
            token("textureSampleBaseClampToEdge"),
            token("textureStore"),
        ),
        atomic_builtin_function_name: $ => choice(
            token("atomicLoad"),
            token("atomicStore"),
            token("atomicAdd"),
            token("atomicSub"),
            ...
            token("atomicOr"),
            token("atomicXor"),
            token("atomicExchange"),
            token("atomicCompareExchangeWeak"),
        ),
        data_packing_builtin_function_name: $ => choice(
            token("pack4x8snorm"),
            token("pack4x8unorm"),
            token("pack4xI8"),
            token("pack4xU8"),
        ...
        data_unpacking_builtin_function_name: $ => choice(
            token("unpack4x8snorm"),
            token("unpack4x8unorm"),
            token("unpack4xI8"),
            token("unpack4xU8"),
            token("unpack4xI8Clamp"),
            token("unpack4xU8Clamp"),
            token("unpack2x16snorm"),
            token("unpack2x16unorm"),
            token("unpack2x16float"),
        ),
        synchronization_builtin_function_name: $ => choice(
            token("storageBarrier"),
            token("textureBarrier"),
            token("workgroupBarrier"),
            token("workgroupUniformLoad"),
        ),
        access_mode: $ => choice(
            token('read'),
            token('write'),
